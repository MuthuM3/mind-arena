# Mind Arena Product Blueprint

This blueprint defines the product before implementation. It separates the durable product thesis
from replaceable technical choices.
...
- [ADR-0001: Solo Decision Arena](decisions/0001-v1-signature-experience.md) — superseded
- [ADR-0002: Solo-first staged hybrid architecture](decisions/0002-staged-hybrid-architecture.md) —
  superseded
- [ADR-0003: Collaboration-first thesis](decisions/0003-collaboration-first-product.md)
